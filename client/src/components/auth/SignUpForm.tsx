  ...
  >
    ...
    <div className="flex flex-col items-center gap-3 pt-2">
      ...
      <div className="text-center">
        ...
        <h2 className="mt-1 font-space-grotesk text-2xl font-bold text-slate-900 dark:text-dk-text">Verify your email</h2>
    ...
    <div className="space-y-2">
      <label className="block text-sm font-semibold text-slate-700 dark:text-dk-text-2">Verification code</label>
      <input
        type="text"
        inputMode="numeric"
        maxLength={6}
    ...
    <div className="space-y-3">
      ...
      <button
        type="button"
        onClick={onBack}
        className="w-full rounded-2xl border border-slate-200 dark:border-dk-border py-3 text-sm font-semibold text-slate-600 dark:text-dk-text-2 transition hover:border-slate-300 dark:hover:border-white/20 hover:text-slate-900 dark:hover:text-slate-200"
      >
        ← Back to sign up
      </button>
    </div>
