...
const AdminSidebar = () => {
  ...
  return (
    <aside className="md:w-64 w-20 border-r border-slate-200 dark:border-dk-border bg-white dark:bg-dk-base min-h-screen py-8 flex flex-col">
            ...
            className={({ isActive }) =>
              `flex items-center gap-3 py-3 px-4 rounded-xl transition-all duration-200 ${
                isActive
                  ...
                  : 'text-slate-500 dark:text-dk-text-2 hover:bg-slate-50 dark:hover:bg-dk-surface-2 hover:text-slate-900 dark:hover:text-white'
              }`
            }
          >
      ...
      <div className="px-3 pt-6 border-t border-slate-100 dark:border-dk-border">
        <button
          type="button"
          onClick={() => window.location.assign('/')}
          className="flex w-full items-center gap-3 py-3 px-4 rounded-xl text-slate-500 dark:text-dk-text-2 hover:bg-red-50 dark:hover:bg-red-900/10 hover:text-red-600 dark:hover:text-red-400 transition-all duration-200"
        >
