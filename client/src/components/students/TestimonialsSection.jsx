        ...
        {platformHomeData.testimonials.length > 0 ? (
          platformHomeData.testimonials.map((testimonial, idx) => (
            <motion.div
              ...
              className="group bg-white dark:bg-dk-surface border border-slate-200 dark:border-dk-border rounded-2xl p-6 flex flex-col h-full shadow-sm transition-all duration-300 hover:shadow-xl hover:-translate-y-1"
            >
              <div className="flex items-center gap-4 mb-6">
                <img
                  src={testimonial.image || undefined}
                  alt={testimonial.name || 'Student'}
                  className="w-12 h-12 rounded-full object-cover bg-slate-100 dark:bg-dk-surface-2 ring-2 ring-offset-2 ring-transparent group-hover:ring-blue-500 transition-all duration-300"
                />
                <div className="text-left">
                  <h3 className="font-bold text-sm text-slate-900 dark:text-dk-text">
              ...
              <p className="text-sm text-slate-600 dark:text-dk-text-2 italic line-clamp-4 leading-relaxed">
